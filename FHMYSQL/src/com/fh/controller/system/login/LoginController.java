...
import com.fh.util.wether.HttpUtils;
/*
 * 总入口
 */
@Controller
	...
	public ModelAndView login_index(@PathVariable("changeMenu") String changeMenu){
		...
		try{
			...
			if (user != null) {
			    ...
			    headers.put("Authorization", "APPCODE "+Const.wether_APPCODE);
			    Map<String, String> querys = new HashMap<String, String>();
			    querys.put("city", Const.wether_city);
			    querys.put("citycode", "citycode");
			    querys.put("cityid", "cityid");
				HttpResponse response = HttpUtils.doGet(Const.wether_host, Const.wether_path, "GET", headers, querys);
			 //   mv.addObject("wether", new JSONObject().fromObject( EntityUtils.toString(response.getEntity())) );
			  //获取天气 阿里数据
