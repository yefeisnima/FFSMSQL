...
public class ToolController extends BaseController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getWether")
	public Object getWether() throws Exception{
		    String host = "http://jisutqybmf.market.alicloudapi.com";
		    String path = "/weather/query";
		    String method = "GET";
		    Map<String, String> headers = new HashMap<String, String>();
		    headers.put("Authorization", "APPCODE a5c25feb822248db9b3bdbd79c73522a");
...
//	    	获取response的body
	    	JSONObject j= JSONObject.fromObject( EntityUtils.toString(response.getEntity()));
