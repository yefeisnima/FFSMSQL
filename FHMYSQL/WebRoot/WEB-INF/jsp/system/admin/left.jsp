					  ...
					  <ul class="submenu">
							<c:forEach items="${menu.subMenu}" var="sub">
								...
								<c:choose>
									...
									<li id="z${sub.MENU_ID }">
									<a style="cursor:pointer;" target="mainFrame"  onclick="siMenu('z${sub.MENU_ID }','lm${menu.MENU_ID }','${sub.MENU_NAME }','${sub.MENU_URL }')"><i class="${menu.MENU_ICON}"></i>${sub.MENU_NAME }</a></li>
									</c:when>
									<c:otherwise>
